...
if (diaSemana.toLowerCase() === "domingo") {
  console.log("¡Estás de suerte, la tarifa es GRATIS!");
} else {
...
// otra alternativa es usar una variable para el costo, y dependiendo de el vehiculo cambia su valor, por ejemplo : costo = 5